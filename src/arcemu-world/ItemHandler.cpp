...
void WorldSession::HandleBuyItemInSlotOpcode(WorldPacket & recv_data)   // drag & drop
{
	...
	{
		QueryResult * result = WorldDatabase.Query("SELECT name1 FROM items WHERE entry='%u'", itemid);

		Field * itemname = result->Fetch();

		if(unit->GetEntry() == 100010) // custom1
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97014|h[Level 1 Item Show]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100011)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97008|h[Level 2 Item Show]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100012)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97032|h[Level 3 Item Show]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100013)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97009|h[Level 4 Item Show]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100014)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97010|h[Level 5 Item Show]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100015)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97011|h[Level 6 Item Show]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 90007)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:70001|h[Heirbloom Proof]|h %sX 35 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %scoin:%s5000G %shonor:%s80000 %sarena:%s5000.|r",MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW,  MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 90008)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97030|h[Vip Deluxe T5]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 90009)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need honor:%s32400 %sarena:%s12500.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 90010)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need honor:%s18100 %sarena:%s5500.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100001)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97033|h[Wrathful Upgrade]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 1 %shonor:%s16000 %sarena:%s14000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100009)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need coin:%s20000G.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		////items
		else if(itemid == 171502) // legend thunderfury
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffff8000|Hitem:19019|h[Thunderfury, Blessed Blade of the Windseeker]|h %sX 1 %scoin:%s12000G %shonor:%s80000 %sarena:%s25000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 171500) // lv.1 thunderfury
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffff8000|Hitem:19019|h[Thunderfury, Blessed Blade of the Windseeker]|h %sX 1 %scoin:%s2000G %shonor:%s80000 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 171501) // lv.2 thunderfury
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffff8000|Hitem:19019|h[Thunderfury, Blessed Blade of the Windseeker]|h %sX 1 %scoin:%s5000G %shonor:%s80000 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 171466 || itemid == 171467 || itemid == 171468 || itemid == 171469 || itemid == 171470 || itemid == 171471 || itemid == 171472 || itemid == 171473)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffA335EE|Hitem:18842|h[Staff of Dominance]|h %sX 1 %scoin:%s19999G %shonor:%s29999 %sarena:%s7660.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		//Olympic Comittee elixirs
		else if(itemid == 97041 || itemid == 97042 || itemid == 97043 || itemid == 97044 || itemid == 97045 || itemid == 97046 || itemid == 97047 || itemid == 97048 || itemid == 97049 || itemid == 97050 || itemid == 97051 || itemid == 97052 || itemid == 97053 || itemid == 97054 || itemid == 97055 || itemid == 97056 || itemid == 97057 || itemid == 97058 || itemid == 97059 || itemid == 97060 || itemid == 97061 || itemid == 97062 || itemid == 97063 || itemid == 97064 || itemid == 97065 || itemid == 97066 || itemid == 97067)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffff8000|Hitem:97016|h[Bronze]|h %sX 15.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		//Olympic Comittee gold Olympic Gear 
		else if(itemid == 161200 || itemid == 161201 || itemid == 161202 || itemid == 161203 || itemid == 161204 || itemid == 161205 || itemid == 161206 || itemid == 161207 || itemid == 161220 || itemid == 161221 || itemid == 161222 || itemid == 161223 || itemid == 161224 || itemid == 161225 || itemid == 161226 || itemid == 161227 || itemid == 161240 || itemid == 161241 || itemid == 161242 || itemid == 161243 || itemid == 161244 || itemid == 161245 || itemid == 161246 || itemid == 161247 || itemid == 161260 || itemid == 161261 || itemid == 161262 || itemid == 161263 || itemid == 161264 || itemid == 161265 || itemid == 161266 || itemid == 161267)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffff8000|Hitem:97018|h[Gold]|h %sX 20.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		//Olympic Comittee silver Olympic Gear
		else if(itemid == 161208 || itemid == 161209 || itemid == 161210 || itemid == 161211 || itemid == 161212 || itemid == 161213 || itemid == 161214 || itemid == 161215 || itemid == 161228 || itemid == 161229 || itemid == 161230 || itemid == 161231 || itemid == 161232 || itemid == 161233 || itemid == 161234 || itemid == 161235 || itemid == 161248 || itemid == 161249 || itemid == 161250 || itemid == 161251 || itemid == 161252 || itemid == 161253 || itemid == 161254 || itemid == 161255 || itemid == 161268 || itemid == 161269 || itemid == 161270 || itemid == 161271 || itemid == 161272 || itemid == 161273 || itemid == 161274 || itemid == 161275)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffff8000|Hitem:97017|h[Silver]|h %sX 20.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		//Sayge's Scrolls
		else if(itemid == 96000 || itemid == 96001 || itemid == 96002 || itemid == 96003 || itemid == 96004 || itemid == 96005 || itemid == 96006 || itemid == 96007)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need coin:%s6650G %sarena:%s8000", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170044)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:30902|h[Cataclysm's Edge]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170045)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:24550|h[Gladiator's Greatsword]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170046)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:29993|h[Twinblade of the Phoenix]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170047)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:29356|h[Quantum Blade]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170048)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:32332|h[Torch of the Damned]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170049)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:30090|h[World Breaker]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170050)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:31959|h[Merciless Gladiator's Bonegrinder]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170051)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:28800|h[Hammer of the Naaru]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170052)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:32348|h[Soul Cleaver]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170053)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:31966|h[Merciless Gladiator's Decapitator]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170054)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:28587|h[Legacy]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 170055)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cffa335ee|Hitem:34891|h[The Blade of Harbingers]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %shonor:%s36600 %sarena:%s5000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(itemid == 100042) // Need Guardian of the Black Sky Dragon Professor Moon Ponchos
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100021|h[Deluxe Guardian of the Black Sky Dragon Professor Moon Ponchos]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100043) // Need Guardian of the Blue Sky Dragon Professor Moon Ponchos
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100022|h[Deluxe Guardian of the Blue Sky Dragon Professor Moon Ponchos]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100044) // Need Guardian of the Red Sky Dragon Professor Moon Ponchos
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100023|h[Deluxe Guardian of the Red Sky Dragon Professor Moon Ponchos]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100045) // Need Guardian of the Green Sky Dragon Professor Moon Ponchos
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100024|h[Deluxe Guardian of the Green Sky Dragon Professor Moon Ponchos]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100049) // Need Miracle Guard Endurace
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100007|h[Deluxe Miracle Guard Endurace]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100046) // Need Miracle Guard Resistance
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100041|h[Deluxe Miracle Guard Resistance]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100051) // Need Miracle Guard Forces
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100002|h[Deluxe Miracle Guard Forces]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100048) // Need Miracle Guard Intelligence
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100000|h[Deluxe Miracle Guard Intelligence]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100050) // Need Miracle Guard Nimble
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100001|h[Deluxe Miracle Guard Nimble]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100003) // Need Miracle Dark Oath
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100028|h[Deluxe Miracle Dark Oath]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100004) // Need Miracle Ice Oath
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100029|h[Deluxe Miracle Ice Oath]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 100005) // Need Miracle Magic Oath
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need |cffff8000|Hitem:100015|h[Deluxe Miracle Magic Oath]|h %sX 1 |cffff8000|Hitem:97004|h[item Upgrade]|h %sX 40 %sarena:%s10000.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		else if(itemid == 60000)
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need %scoin:%s10000 %sarena:%s800.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED, MSG_COLOR_AHYELLOW, MSG_COLOR_RED);
		}
		_player->GetItemInterface()->BuildInventoryChangeError(NULL, NULL, error);
		return;
	}
...
//	int8 bagslot = 0;
	...
	{		
		...
		if(unit->GetEntry() == 100010) // custom2
		{
			_player->BroadcastMessage("%s<Item> |Hitem:%u|h[ ? ]|h %sFail:Need item: |cff00ff00|Hitem:97014|h[Level 1 Item Show]|h %sX 1.|r", MSG_COLOR_AHYELLOW, itemid, MSG_COLOR_RED, MSG_COLOR_AHYELLOW);
		}
		else if(unit->GetEntry() == 100011)
	...
	/*		if(item.extended_cost->costid == 3000) ////custom
		{
			_player->BroadcastMessage("fail need <Item> |cffFFFFFF|Hitem:%u|h[%u]|h|r X %u. |cffFF0000Need Item:|r |cff00ff00|Hitem:97008|h[Vip Item Token]|h|r.", itemid, itemid, amount);
		}
		else*/
...
void WorldSession::SendInventoryList(Creature* unit)
{
	...
	if(!unit->HasItems())
	{
		sChatHandler.BlueSystemMessageToPlr(_player, "No items found.");
