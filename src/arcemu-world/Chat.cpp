...
void CommandTableStorage::Init()
{
	...
	static ChatCommand honorCommandTable[] =
	{
		...
		{ "addarenapoints",    'm', &ChatHandler::HandleAddArenaCommand,                    "Adds x amount of honor points/currency",                  NULL, 0, 0, 0 },
	...
	{
		{ "ingame",        '0', &ChatHandler::HandleGMListCommand,        "Shows active GM's",                                   NULL, 0, 0, 0 },
	...
	static ChatCommand commandTable[] =
	{
		...
		/*{ "kick",            'g', NULL,                                                     "",                                                                                                                                        kickCommandTable,         0, 0, 0 },*/
		...
		{ "kickplayer",      'g', &ChatHandler::HandleKickCommand,                          "Kicks player from server",                                                                                                                NULL,                     0, 0, 0 },
		...
		//custom commands
		{ "showitem",        '0', &ChatHandler::HandleShowItemCommand,                      "Shows item with entryId",                                                                                                                  NULL,                     0, 0, 0 },
		{ "addmg",			 'z', &ChatHandler::HandleAddMGCommand,                      "Adds Magic Gold to account. need target",                                                                                                                  NULL,                     0, 0, 0 },
		{ "addviplevel",	 'z', &ChatHandler::HandleAddVipLevelCommand,                "Gives vip level to the target player",                                                                                                                  NULL,                     0, 0, 0 },
		{ "banaccbychar",	 'g', &ChatHandler::HandleBanAccByChar,                      "Bans account by player name (player must be online).",                                                                                                                  NULL,                     0, 0, 0 },
		{ NULL,              '0', NULL,                                                     "",                                                                                                                                        NULL,                     0, 0, 0 }
	};
