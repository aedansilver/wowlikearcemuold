...
#define MSG_COLOR_AHGREEN		 "|c1f40af20"
#define MSG_COLOR_AHYELLOW		 "|c1fD8C300"
#define MSG_COLOR_LIGHTRED       "|cffff6060"
...
#define MSG_COLOR_VIP0			 "|cff00FF00"
#define MSG_COLOR_VIP1			 "|cffFF5100"
#define MSG_COLOR_VIP2			 "|cffFF1500"
#define MSG_COLOR_VIP3			 "|cffFFAB00"
#define MSG_COLOR_VIP4			 "|cffFAF37B"
#define MSG_COLOR_VIP5			 "|cffFF0073"
#define MSG_COLOR_VIP6			 "|cffC70202"
#define MSG_COLOR_VIP7			 "|cffFA3FF7"
#define MSG_COLOR_VIP8			 "|cffA811A5"
#define MSG_COLOR_VIP9			 "|cffA8116B"
#define MSG_COLOR_VIPSAYCHAT	 "|cff9370DB"
...
class SERVER_DECL ChatHandler : public Singleton<ChatHandler>
{
	...
	protected:
		...
		bool HandleAddMGCommand(const char* args, WorldSession* m_session);
		bool HandleAddVipLevelCommand(const char* args, WorldSession* m_session);
		...
		bool HandleBanAccByChar(const char* args, WorldSession* m_session);
		...
		bool HandleAddArenaCommand(const char* args, WorldSession* m_session);
		...
		bool ChatHandler::HandleShowItemCommand(const char* args, WorldSession* m_session);
