	...
	switch(type)
	{
		...
		case CHAT_MSG_CHANNEL:
				...
				do
			{
					...
					if((chn->m_name == sWorld.getGmClientChannel().c_str()))
					{
					snprintf(worldgmchat, 1024, "[G.M Channel]%s[|Hplayer:%s|h%s|h]: %s", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				else if (field[0].GetUInt32() == 1)
					{
						// VIP 1
						snprintf(worlchat, 1024, "|cff00ff00[World Channel|cff00ff00]%s|cff00ff00[%s|Hplayer:%s|h%s|h|cff00ff00]: %s|r", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", MSG_COLOR_VIP1, GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				else if (field[0].GetUInt32() == 2)
					{
						// VIP 2
						snprintf(worlchat, 1024, "|cff00ff00[World Channel|cff00ff00]%s|cff00ff00[%s|Hplayer:%s|h%s|h|cff00ff00]: %s|r", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", MSG_COLOR_VIP2, GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				else if (field[0].GetUInt32() == 3)
					{
						// VIP 3
						snprintf(worlchat, 1024, "|cff00ff00[World Channel|cff00ff00]%s|cff00ff00[%s|Hplayer:%s|h%s|h|cff00ff00]: %s|r", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", MSG_COLOR_VIP3, GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				else if (field[0].GetUInt32() == 4)
					{
						// VIP 4
						snprintf(worlchat, 1024, "|cff00ff00[World Channel|cff00ff00]%s|cff00ff00[%s|Hplayer:%s|h%s|h|cff00ff00]: %s|r", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", MSG_COLOR_VIP4, GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				else if (field[0].GetUInt32() == 5)
					{
						// VIP 5
						snprintf(worlchat, 1024, "|cff00ff00[World Channel|cff00ff00]%s|cff00ff00[%s|Hplayer:%s|h%s|h|cff00ff00]: %s|r", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", MSG_COLOR_VIP5, GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				else if (field[0].GetUInt32() == 6)
					{
						// VIP 6
						snprintf(worlchat, 1024, "|cff00ff00[World Channel|cff00ff00]%s|cff00ff00[%s|Hplayer:%s|h%s|h|cff00ff00]: %s|r", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", MSG_COLOR_VIP6, GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				else
					{
						/// non vip
						snprintf(worlchat, 1024, "|cff00ff00[World Channel|cff00ff00]%s|cff00ff00[%s|Hplayer:%s|h%s|h|cff00ff00]: %s|r", GetPlayer()->HasFlag(PLAYER_FLAGS, PLAYER_FLAG_GM) ? " |r<G.M>|r |Tinterface\\ChatFrame\\UI-ChatIcon-Blizz.blp:12:24:1:-1|t " : " ", MSG_COLOR_VIP0, GetPlayer()->GetName(), GetPlayer()->GetName(), msg.c_str());
					}
				///send world channel stuff after all these lines (thanks to QQrofl
				sWorld.SendGMWorldText(worldgmchat);
				sWorld.SendWorldText(worlchat);
