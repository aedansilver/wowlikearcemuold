...
// ToDo: Encapsulate below this point
	public:
		...
		void SetServerNamecK(const char* ServerNamecK) { m_ServerNamecK = ServerNamecK; }
		ARCEMU_INLINE const char* GetServerNamecK() const { return m_ServerNamecK.c_str(); }
	...
	public:
		...
		//Vip Loot rate
		uint32 MemberLoot;
		uint32 MemberLootOne;
		uint32 MemberLootTwo;
		uint32 MemberLootThree;
		uint32 MemberLootFour;
		uint32 MemberLootFive;
		uint32 MemberLootSix;
		int member_type;

		std::string m_ServerNamecK;
		// end vip loot
